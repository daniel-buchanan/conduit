    ...
    where T: class
{
    ...
    /// <param name="prefetchDuration">The duration of the stage prefetch.</param>
    ...
    void SetStageMetric(int index, string name, long prefetchDuration, long duration, bool success, Exception? exception = null);
}