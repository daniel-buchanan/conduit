...
/// <param name="PrefetchDuration">The duration of the prefetch.</param>
...
public record StageMetric(int Index, string Name, long PrefetchDuration, long Duration, bool Success = true, Exception? Exception = null)
{
    /// <summary>
    ...
    public long PrefetchDuration { get; } = PrefetchDuration;
