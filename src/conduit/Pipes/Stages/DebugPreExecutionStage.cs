...
/// <summary>
/// Represents a debug pipe stage that executes before the main request handler.
/// This stage logs a debug message indicating pre-execution.
/// </summary>
...
public class DebugPreExecutionStage<TRequest, TResponse>(ILog logger) : PipeStage<TRequest, TResponse>(logger) 
    where TRequest : class, IRequest<TResponse>
    where TResponse : class
{
    /// <summary>
    /// Executes the debug pre-execution logic, logging a message.
    /// </summary>
